    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <label>
                    Cliente:
                    <input type="text" name="customer_id" value={order.customer_id} onChange={handleChange} />
                </label>
                <label>
                    Método de Pagamento:
                    <input type="text" name="payment_method" value={order.payment_method} onChange={handleChange} />
                </label>
                <label>
                    Produto:

        ...
        <div className="table-container">
            <div className="table-header">
                ...
                <div className="table-actions">
                    <Button onClick={() => navigate('/customers/create')} title="Criar Cliente" color="#808080" />
                    ...
                    {customers.map(customer => (
                        <tr key={customer.id}>
                            ...
                            <td>
                                ...
                                <Button onClick={() => { }} title="Histórico de Pedidos" color="#FFA500" />
                                <Button onClick={() => { }} title="Consumo Médio" color="#FFA500" />
                            </td>
                        </tr>
                    ))}
                </tbody>
